...
$(document).ajaxComplete(function(){$(".loading").delay(1E3).slideUp(500,function(){$(this).remove()});$(".close-portfolio span").click(function(b){$(".portfolio-item-details").delay(500).slideUp(500,function(){$(this).remove()});window.location.hash="!";return!1})/* Portfolio details - close. */
